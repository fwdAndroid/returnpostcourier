...
class transferSell extends StatefulWidget {
  const transferSell({Key? key}) : super(key: key);

  @override
  State<transferSell> createState() => _transferSellState();
}

class _transferSellState extends State<transferSell> {
  @override
